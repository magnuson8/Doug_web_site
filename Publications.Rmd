...
Magnuson, D., Jansson, M., Benoit, C. (in press). Foster care as a support system for early leavers. In Varda Mann-Feder, (ed). *Leaving Care and the Transition to Adulthood.* Oxford University Press. 

Benoit, C., Smith, M., Jansson, M., Healey, P., & Magnuson, D. (accepted for publication). The prostitution problem: claims and evidence. *Archives of Sexual Behavior*.
...
Magnuson, D., & Healey, P. (2018). The multi-armed bandit algorithm. *CYC-Online*, in press. 
